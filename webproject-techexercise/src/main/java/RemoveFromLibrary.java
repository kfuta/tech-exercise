...
public class RemoveFromLibrary extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String removeSql = "DELETE FROM books WHERE title=? AND author=?";
      ...
      String header = "Library Removal Complete!";
      ...
      out.println("<h2 align=\"center\">" + header + "</h2>\n"	// header
        	+ "<section>You removed the following book from your library: <br><section>"	
            + "<ul>\n" + // list
